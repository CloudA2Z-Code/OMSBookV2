...
$RunbookPath = "C:\InsideOMSv2\Chapter 6\runbooks\Install-OMSExtensionV2VMGraphical.graphrunbook"
...
Import-AzureRmAutomationRunbook -Path $RunbookPath `
                                ...
                                -Name "Install-OMSExtensionV2VMGraphical" `
                                -Type GraphicalPowerShellWorkflow `
                                -Published `
                                -Force `
...
# Start runbook job
Start-AzureRmAutomationRunbook -Name "Install-OMSExtensionV2VMGraphical" `
                               -Parameters $params `
                               -Wait `
                               -ResourceGroupName $ResouceGroupName `
                               -AutomationAccountName $AutomationAccountName
